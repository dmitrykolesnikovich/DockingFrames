...
public class BackgroundExample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    controller.getThemeManager()
      .setBackgroundPaint(ThemeManager.BACKGROUND_PAINT + ".custom", new CustomPaint(frame.getContentPane(), image, alphaWork));
...
//		controller.setTheme( new BasicTheme() );
  ...
  private static BufferedImage createBackground(BufferedImage image, int width, int height) {
    ...
    g.drawImage(image, width / 2 - mw / 2, height / 2 - mh / 2, width / 2 + mw / 2, height / 2 + mh / 2, imageWidth / 2 - mw / 2,
