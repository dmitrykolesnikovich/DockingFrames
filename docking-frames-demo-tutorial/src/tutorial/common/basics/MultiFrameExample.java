...
public class MultiFrameExample {
  ...
  private static class ExampleFrame extends JTutorialFrame {
    ...
    public ExampleFrame(final int location, final Application application) {
      ...
      north.add(switcher,
                new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0,
                                       0));
      north.add(add,
                new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0,
                                       0));
