...
public class PersistentLayoutExample {
  ...
  public static abstract class FrontendLayoutListAction extends FrontendAction {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      String layout = (String)JOptionPane
        .showInputDialog(frontend.getController().findRootWindow(), "Choose one", "Input", JOptionPane.INFORMATION_MESSAGE, null, list,
                         frontend.getCurrentSetting());
      if (layout != null) {
        action(layout);
      }
    }
