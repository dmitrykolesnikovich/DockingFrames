...
public class TitleAction extends SimpleButtonAction {
  ...
  public void action(Dockable dockable) {
    ...
    String title =
      JOptionPane.showInputDialog(dockable.getComponent(), "Please enter new title of note", "Change title", JOptionPane.PLAIN_MESSAGE);

    if (title != null) TitleAction.this.note.setTitle(title);
  }
}
