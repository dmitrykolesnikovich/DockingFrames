...
public class FontChooser extends JComponent {
  ...
  private JList list = new JList(GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames());
  ...
  protected void createGUI(JList list,
                           JCheckBox boxBold,
                           JCheckBox boxItalic,
                           JSpinner fontSize,
  ...
  protected static class FontDialog extends JDialog {
    ...
    private void init() {
      ...
      add(chooser,
          new GridBagConstraints(0, 0, 1, 1, 100.0, 100.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0,
                                 0));
      ...
      add(buttonPanel,
          new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.LAST_LINE_END, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0,
                                 0));
