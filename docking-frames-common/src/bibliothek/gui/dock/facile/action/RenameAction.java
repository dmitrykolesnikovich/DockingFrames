...
public abstract class RenameAction extends SimpleButtonAction {
  ...
  public RenameAction(DockController controller) {
    ...
    menu.add(titleField,
             new GridBagConstraints(0, 0, 1, 1, 100.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 1, 1, 1), 0,
                                    0));
    menu.add(panel,
             new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(1, 1, 1, 1), 0,
                                    0));
