...
public class LocationModeManager<M extends LocationMode> extends ModeManager<Location, M> {
  ...
  public static final PropertyKey<ExtendedModeEnablementFactory> MODE_ENABLEMENT =
    new PropertyKey<ExtendedModeEnablementFactory>("locationmodemanager.mode_enablement",
                                                   new ConstantPropertyFactory<ExtendedModeEnablementFactory>(
                                                     DefaultExtendedModeEnablement.FACTORY), true);
  ...
  public static final PropertyKey<DoubleClickLocationStrategy> DOUBLE_CLICK_STRATEGY =
    new PropertyKey<DoubleClickLocationStrategy>("locationmodemanager.double_click_strategy",
                                                 new ConstantPropertyFactory<DoubleClickLocationStrategy>(
                                                   DoubleClickLocationStrategy.DEFAULT), true);
  ...
  private PropertyValue<DoubleClickLocationStrategy> doubleClickStrategy =
    new PropertyValue<DoubleClickLocationStrategy>(DOUBLE_CLICK_STRATEGY) {
      @Override
  ...
  private PropertyValue<ExtendedModeEnablementFactory> extendedModeFactory =
    new PropertyValue<ExtendedModeEnablementFactory>(MODE_ENABLEMENT) {
      @Override
  ...
  private DoubleClickListener doubleClickListener = new DoubleClickListener() {
    ...
    public boolean process(Dockable dockable, MouseEvent event) {
      ...
      if (dockable != null) {
        ...
        ExtendedMode next =
          getDoubleClickStrategy().handleDoubleClick(dockable, current == null ? null : current.getExtendedMode(), enablement);
  ...
  public boolean isModeAvailable(Dockable dockable, ExtendedMode mode) {
    if (enablement == null) return false;
  ...
  public void removeListener(Path identifier, LocationModeListener listener) {
    ...
    if (list.isEmpty()) listeners.remove(identifier);
  ...
  public M getCurrentMode(Dockable dockable) {
    while (dockable != null) {
      for (M mode : modes()) {
        if (mode.isCurrentMode(dockable)) return mode;
      }
