...
public class DefaultExtendedModeEnablement extends AbstractExtendedModeEnablement {
  ...
  public DefaultExtendedModeEnablement(LocationModeManager<?> manager) {
    super(manager);
    init();
    List<ExtendedModeEnablementFactory> factories = manager.getController().getExtensions()
      .load(new ExtensionName<ExtendedModeEnablementFactory>(EXTENSION, ExtendedModeEnablementFactory.class));
