...
public class LookAndFeelList {
  ...
  public void insert(int index, Info info) {
    if (info == null) throw new NullPointerException("Info must not be null");
  ...
  public Info getFull(int index) {
    if (index == 0) return getDefault();

    if (index == 1) return getSystem();
  ...
  public int indexOfFull(Info info) {
    if (info == defaultInfo) return 0;

    if (info == systemInfo) return 1;
  ...
  public Info getFull(String key) {
    if ("s.default".equals(key)) return getDefault();

    if ("s.system".equals(key)) return getSystem();
  ...
  public String keyOfFull(Info info) {
    if (info == defaultInfo) return "s.default";

    if (info == systemInfo) return "s.system";
  ...
  public void setLookAndFeel(Info lookAndFeel) {
    if (lookAndFeel == currentInfo) return;

    if (lookAndFeel == null) throw new NullPointerException("lookAndFeel must not be null");
  ...
  public void setDefault(Info defaultInfo) {
    if (defaultInfo == null) throw new NullPointerException("argument must not be null");
  ...
  public void setSystem(Info systemInfo) {
    if (systemInfo == null) throw new NullPointerException("argument must not be null");
