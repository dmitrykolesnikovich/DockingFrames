...
public class CommonDockStationFactory
  ...
  protected CommonDockStation<?, ?> createStation(String id) {
    ...
    if (!factoryId.equals(getID())) {
      throw new IllegalArgumentException("Wrong type of dockable for unique id '" +
                                         id +
                                         "': The backup factory created a dockable which expects a factory of type '" +
                                         factoryId +
                                         "',  but the call was done from a factory of type '" +
                                         getID() +
                                         "'");
    }
  ...
  @SuppressWarnings("unchecked")
  public void setLayout(CommonDockStation<?, ?> element,
  ...
  @SuppressWarnings("unchecked")
  public void layoutPerspective(CommonDockStationPerspective element,
                                CommonDockStationLayout layout,
