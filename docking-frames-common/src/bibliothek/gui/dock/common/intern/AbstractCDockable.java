...
public abstract class AbstractCDockable implements CDockable {
  ...
  protected void init(CommonDockable dockable) {
    if (this.dockable != null) throw new IllegalStateException("dockable already set");
  ...
  public void setVisible(boolean visible) {
    if (control == null) {
      throw new IllegalStateException(
        "This CDockable does not know its CControl. Call CControl.addDockable(...) to connect this CDockable befor calling setVisible(...).");
    }
  ...
  public void setExtendedMode(ExtendedMode extendedMode) {
    if (extendedMode == null) throw new NullPointerException("extendedMode must not be null");

    if (extendedMode == ExtendedMode.EXTERNALIZED) {
      if (!isExternalizable()) return;
    }
    ...
    CControlAccess control = control();
    if (control != null) control.getLocationManager().setMode(intern(), extendedMode);
  }
  ...
  public void setDefaultLocation(ExtendedMode mode, CLocation location) {
    ...
    if (location == null) {
      ...
      if (control != null) {
        ...
        if (state.getLocation(intern(), mode) == null) state.setLocation(intern(), mode, location);
      }
    }
  }
