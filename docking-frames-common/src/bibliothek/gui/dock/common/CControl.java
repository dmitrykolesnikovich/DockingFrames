...
public class CControl {
   ...
   */
  public static final PropertyKey<KeyStroke> KEY_CANCEL_OPERATION = new PropertyKey<KeyStroke>("ccontrol.cancel_dnd");
  ...
  public static final PropertyKey<ConflictResolver<RequestDimension>> RESIZE_LOCK_CONFLICT_RESOLVER =
    new PropertyKey<ConflictResolver<RequestDimension>>("ccontrol.resize_lock_conflict_resolver",
                                                        new ConstantPropertyFactory<ConflictResolver<RequestDimension>>(
   ...
   */
  public static final PropertyKey<CGroupingBehavior> GROUPING_BEHAVIOR = new PropertyKey<CGroupingBehavior>("ccontrol.groupingBehavior",
                                                                                                            new ConstantPropertyFactory<CGroupingBehavior>(
                                                                                                              new DefaultCGroupingBehavior()),
                                                                                                            true);
  ...
  protected void init(WindowProvider window, CControlFactory factory) {
    ...
    frontend.getController().getFocusController()
      .addVetoListener(new ControlVetoFocusListener(this, listenerCollection.getVetoFocusListener()));
    ...
    controller.getKeyboardController().addListener(new KeyboardListener() {
      public boolean keyPressed(DockElement element, KeyEvent event) {
        if (element instanceof CommonDockable) {
          ...
          if (access != null) {
            if (access.getKeyboardListener().keyPressed(source, event)) return true;
          }
      ...
      public boolean keyReleased(DockElement element, KeyEvent event) {
        if (element instanceof CommonDockable) {
          ...
          CDockableAccess access = accesses.get(source);
          if (access != null) {
            if (access.getKeyboardListener().keyReleased(source, event)) return true;
          }
      ...
      public boolean keyTyped(DockElement element, KeyEvent event) {
        if (element instanceof CommonDockable) {
          ...
          CDockableAccess access = accesses.get(source);
          if (access != null) {
            if (access.getKeyboardListener().keyTyped(source, event)) return true;
          }
    ...
    controller.getDoubleClickController().addListener(new DoubleClickListener() {
      public boolean process(Dockable dockable, MouseEvent event) {
        if (dockable instanceof CommonDockable) {
          ...
          CDockableAccess access = accesses.get(source);
          if (access != null) {
            if (access.getDoubleClickListener().clicked(source, event)) return true;
          }
  ...
  protected void initIcons() {
    DefaultIconScheme scheme = new DefaultIconScheme(getController(),
                                                     ...
                                                     new DefaultIconScheme.IconResource("data/bibliothek/gui/dock/common/icons/icons.ini",
                                                                                        null, CControl.class.getClassLoader()));
  ...
  protected void initTexts(Locale locale) {
    ResourceBundle bundleCore =
      ResourceBundle.getBundle("data.bibliothek.gui.dock.core.locale.text", locale, DockController.class.getClassLoader());
    ResourceBundle bundleCommon =
      ResourceBundle.getBundle("data.bibliothek.gui.dock.common.locale.common", locale, CControl.class.getClassLoader());
    ...
    if (ignore) {
      frontend.setIgnoreForEntry(new DockSituationIgnore() {
        public boolean ignoreChildren(DockStation station) {
          ...
          if (cstation != null) return cstation.isWorkingArea();
        ...
        public boolean ignoreElement(DockElement element) {
          if (element instanceof CommonDockable) {
            ...
            if (cdockable.getWorkingArea() != null) return true;
          }
          return false;
        }
  ...
  public CGridArea createGridArea(String uniqueId) {
    ...
    addStation(area, true);
    if (frontend.getDefaultStation() == null) frontend.setDefaultStation(area.getStation());
    return area;
  }
  ...
  private CContentArea createContentArea(String uniqueId, boolean isDefaultContentArea) {
    if (uniqueId == null) throw new NullPointerException("uniqueId must not be null");

    if (!isDefaultContentArea && uniqueId.equals(CONTENT_AREA_STATIONS_ID)) {
      throw new IllegalArgumentException(
        "the unique identifier '" + uniqueId + "' is reserved for the default CContentArea and may not be used by the client");
    }
  ...
  public void removeStationContainer(CStationContainer container) {
    ...
    if (register.getDefaultContentArea() == container) throw new IllegalArgumentException("The default-contentarea can't be removed");
  ...
  public <M extends MultipleCDockable> M addDockable(String uniqueId, M dockable) {
    ...
    if (dockable.getControl() != null) throw new IllegalStateException("dockable is already part of a control");
  ...
  public void replace(MultipleCDockable oldDockable, MultipleCDockable newDockable) {
    if (oldDockable == null) throw new IllegalArgumentException("old dockable must not be null");
    if (newDockable == null) throw new IllegalArgumentException("new dockable must not be null");

    if (oldDockable.getControl() != this) throw new IllegalArgumentException("old dockable not registered at this CControl");

    if (newDockable.getControl() != null) throw new IllegalArgumentException("new dockable alread registered at some CControl");
  ...
  public void setMaximizeArea(String id) {
    ...
    if (area == null) throw new IllegalArgumentException("No area registered with key '" + id + "'");
        ...
        if (area != null && area.asDockable() != null) {
          if (!area.asDockable().isVisible()) {
            throw new IllegalStateException(
              "A dockable that wants to be on a working-area can't be made visible unless the working-area is visible.");
          }
        }
