...
public class CPreferenceMenuPiece extends BaseMenuPiece {
  ...
  public static CPreferenceMenuPiece setup(CControl control) {
    if (control.getPreferenceModel() == null) control.setPreferenceModel(new CPreferenceModel(control));
  ...
  protected void action() {
    ...
    if (model == null) model = control.getPreferenceModel();
    if (model == null) model = new DefaultPreferenceModel(control.getController());
