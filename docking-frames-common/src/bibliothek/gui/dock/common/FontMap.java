...
public class FontMap {
  ...
  private String[] split(String modification) {
    ...
    if (index < 0) throw new IllegalArgumentException("not in the form 'key'='value': " + modification);
    ...
    if (key.length() == 0) throw new IllegalArgumentException("missing key in: " + modification);

    if (value.length() == 0) throw new IllegalArgumentException("missing value in: " + modification);
