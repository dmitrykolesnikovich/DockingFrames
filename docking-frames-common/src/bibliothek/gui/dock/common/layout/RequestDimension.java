...
public class RequestDimension implements Cloneable {
  ...
  public String toString() {
    return getClass() + "[width=" + (widthSet ? String.valueOf(width) : "") + ", height=" + (heightSet ? String.valueOf(height) : "") + "]";
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (heightSet != other.heightSet) return false;
    if (width != other.width) return false;
    if (widthSet != other.widthSet) return false;
    return true;
  }
