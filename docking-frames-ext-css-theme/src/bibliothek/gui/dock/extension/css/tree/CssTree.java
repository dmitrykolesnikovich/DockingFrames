...
public class CssTree {
  ...
  @Todo(compatibility = Compatibility.COMPATIBLE, priority = Priority.MAJOR, target = Version.VERSION_1_1_2, description = "have better self nodes, e.g. a dockable could have a property for its title text")
   ...
   */
  @CssDocPath(id = "getPathFor", description = @CssDocText(text = "Generic path for a Dockable or a DockStation, the nodes are created by different CssNodeFactorys."), unordered = {
    ...
    @CssDocPathNode(reference = StackDockStationNode.class), @CssDocPathNode(reference = ScreenDockStationNode.class),
    @CssDocPathNode(reference = SplitDockStationNode.class), @CssDocPathNode(reference = FlapDockStationNode.class),})
