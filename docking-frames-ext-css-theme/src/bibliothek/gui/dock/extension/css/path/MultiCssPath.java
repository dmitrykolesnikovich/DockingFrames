...
public class MultiCssPath extends AbstractCssPath {
  ...
  @Override
  @Todo(compatibility = Compatibility.COMPATIBLE, priority = Priority.MINOR, target = Version.VERSION_1_1_2, description = "use a binary search to find the offset-index")
