 ...
 */
@CssDocPathNode(name = @CssDocKey(key = ScreenDockStationNode.NAME), description = @CssDocText(text = "Relation between a ScreenDockStation and its child(ren)"), properties = {
  ...
  @CssDocKey(key = "height", description = @CssDocText(text = "height of the child (in pixel)"))}, pseudoClasses = {
