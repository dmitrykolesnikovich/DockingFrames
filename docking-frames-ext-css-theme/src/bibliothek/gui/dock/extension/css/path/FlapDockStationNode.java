 ...
 */
@CssDocPathNode(name = @CssDocKey(key = FlapDockStationNode.NAME), description = @CssDocText(text = "Relation between a FlapDockStation and its child(ren)"), properties = {
  @CssDocKey(key = "index", description = @CssDocText(text = "Location of the child on its parent"))}, pseudoClasses = {
