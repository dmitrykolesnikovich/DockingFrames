...
public class PictureDockable extends DefaultMultipleCDockable {
  ...
  public PictureDockable(MultipleCDockableFactory<PictureDockable, ?> factory) {
    ...
    background.add(page,
                   new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0),
                                          0, 0));
  ...
  public void setPicture(Picture picture) {
    if (isVisible() && getPicture() != null) getPicture().removeListener(listener);
    ...
    if (isVisible() && picture != null) picture.addListener(listener);
  }
