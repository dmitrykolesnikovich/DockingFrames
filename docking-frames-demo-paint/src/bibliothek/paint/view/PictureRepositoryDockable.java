...
public class PictureRepositoryDockable extends DefaultSingleCDockable {
  ...
  public PictureRepositoryDockable(final ViewManager manager) {
    ...
    content.add(new JScrollPane(list),
                new GridBagConstraints(0, 0, 1, 1, 1.0, 100.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 1, 1, 1),
                                       0, 0));
  ...
  public String askForName() {
    ...
    while (true) {
      name = JOptionPane.showInputDialog(getContentPane(), message, "New picture", JOptionPane.QUESTION_MESSAGE);
