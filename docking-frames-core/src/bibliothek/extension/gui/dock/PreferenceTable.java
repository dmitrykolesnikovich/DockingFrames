...
public class PreferenceTable extends JPanel {
  ...
  public PreferenceTable() {
    ...
    add(panel, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.HORIZONTAL,
  ...
  private int getOperationIndex(PreferenceOperation operation) {
    ...
    if (reverseOrder) index = operations.size() - 1 - index;
  ...
  protected <V> PreferenceEditor<V> createEditor(Path type) {
    ...
    if (factory == null) throw new IllegalArgumentException("No editor defined for type '" + type.toString() + "'");
  ...
  private class Row<V> implements PreferenceEditorCallback<V> {
    ...
    public void setIndex(int index) {
      ...
      layout.setConstraints(label, new GridBagConstraints(0, index, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
                                                          new Insets(1, 1, 1, 1), 0, 0));

      if (editor != null) {
        layout.setConstraints(editor.getComponent(), new GridBagConstraints(1, index, 1, 1, 100.0, 1.0, GridBagConstraints.LINE_START,
      ...
      if (modelOperations != null) {
        for (Map.Entry<PreferenceOperation, Button> entry : modelOperations.entrySet()) {
          ...
          layout.setConstraints(entry.getValue(), new GridBagConstraints(location, index, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_END,
    ...
    private void setOperation(final PreferenceOperation operation, boolean enabled, final boolean editor) {
      ...
      if (button == null) {
        ...
        layout.setConstraints(button,
                              new GridBagConstraints(location, index, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_END, GridBagConstraints.NONE,
