...
public class ButtonContentPreferenceModel extends AbstractPreferenceModel {
  ...
  public ButtonContent getContent() {
    return new ButtonContent(knobChoice.identifierToValue(knob), iconChoice.identifierToValue(icon), textChoice.identifierToValue(text),
                             childrenChoice.identifierToValue(children), actionsChoice.identifierToValue(actions),
