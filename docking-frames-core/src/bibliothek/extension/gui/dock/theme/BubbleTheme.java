 ...
 */
@ThemeProperties(authors = {"Ivan Seidl",
  "Benjamin Sigg"}, descriptionBundle = "theme.bubble.description", nameBundle = "theme.bubble", webpages = {""})
public class BubbleTheme extends BasicTheme {
  ...
  public static final PropertyKey<ColorScheme> BUBBLE_COLOR_SCHEME =
    new PropertyKey<ColorScheme>("dock.ui.BubbleTheme.ColorScheme", new DynamicPropertyFactory<ColorScheme>() {
  ...
  public static final PropertyKey<DockActionDistributor> ACTION_DISTRIBUTOR =
    new PropertyKey<DockActionDistributor>("dock.bubble.DockActionDistributor",
  ...
  public void install(DockController controller) {
    ...
    controller.getIcons().setScheme(Priority.THEME, new DefaultIconScheme("data/bibliothek/gui/dock/core/bubble/icons.ini",
                                                                          BubbleTheme.class.getClassLoader(), controller));
  ...
  private static class SeparatorGenerator implements ViewGenerator<SeparatorAction, BasicTitleViewItem<JComponent>> {
    public BasicTitleViewItem<JComponent> create(ActionViewConverter converter, SeparatorAction action, Dockable dockable) {
      if (action.shouldDisplay(ViewTarget.TITLE)) return new BubbleSeparator(action);
