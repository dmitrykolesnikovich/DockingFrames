...
public class EclipseTheme extends BasicTheme {
  ...
  public static final PropertyKey<Boolean> PAINT_ICONS_WHEN_DESELECTED =
    new PropertyKey<Boolean>("EclipseTheme paint icons when deselected", new ConstantPropertyFactory<Boolean>(false), true);
  ...
  public static final PropertyKey<TabPainter> TAB_PAINTER =
    new PropertyKey<TabPainter>("EclipseTheme tab painter", new ConstantPropertyFactory<TabPainter>(ArchGradientPainter.FACTORY), true);
  ...
  public static final PropertyKey<ColorScheme> ECLIPSE_COLOR_SCHEME =
    new PropertyKey<ColorScheme>("dock.ui.EclipseTheme.ColorScheme", new DynamicPropertyFactory<ColorScheme>() {
   ...
   * replace tabs
   */
  @Deprecated public static final String TAB_DOCK_TITLE = "eclipse.tab";
  ...
  public void install(DockController controller) {
    ...
    controller.getIcons().setScheme(Priority.THEME, new DefaultIconScheme("data/bibliothek/gui/dock/core/eclipse/icons.ini",
                                                                          EclipseTheme.class.getClassLoader(), controller));
    ...
    controller.getActionViewConverter()
      .putTheme(ActionType.BUTTON, ViewTarget.TITLE, new ViewGenerator<ButtonDockAction, BasicTitleViewItem<JComponent>>() {
    ...
    controller.getActionViewConverter()
      .putTheme(ActionType.CHECK, ViewTarget.TITLE, new ViewGenerator<SelectableDockAction, BasicTitleViewItem<JComponent>>() {
    ...
    controller.getActionViewConverter()
      .putTheme(ActionType.MENU, ViewTarget.TITLE, new ViewGenerator<MenuDockAction, BasicTitleViewItem<JComponent>>() {
    ...
    controller.getActionViewConverter()
      .putTheme(ActionType.RADIO, ViewTarget.TITLE, new ViewGenerator<SelectableDockAction, BasicTitleViewItem<JComponent>>() {
        public BasicTitleViewItem<JComponent> create(ActionViewConverter converter, SelectableDockAction action, Dockable dockable) {
    ...
    controller.getActionViewConverter()
      .putTheme(ActionType.DROP_DOWN, ViewTarget.TITLE, new ViewGenerator<DropDownAction, BasicTitleViewItem<JComponent>>() {
  ...
  public EclipseThemeConnector getThemeConnector(DockController controller) {
    ...
    if (controller != null) connector = controller.getProperties().get(THEME_CONNECTOR);

    if (connector == null) connector = THEME_CONNECTOR.getDefault(null);
