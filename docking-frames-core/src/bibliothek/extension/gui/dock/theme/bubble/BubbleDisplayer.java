 ...
 */
@ColorCodes({"displayer.border.high.active", "displayer.border.high.active.mouse", "displayer.border.high.inactive",
  "displayer.border.high.inactive.mouse", "displayer.border.high.disabled", "displayer.border.low.active",
  "displayer.border.low.active.mouse", "displayer.border.low.inactive", "displayer.border.low.inactive.mouse",
...
public class BubbleDisplayer extends BasicDockableDisplayer {
  ...
  public void setController(DockController controller) {
    ...
    if (old != controller) {
      if (old != null) old.removeDockableFocusListener(listener);

      if (controller != null) controller.addDockableFocusListener(listener);
  ...
  public void setTitle(DockTitle title) {
    ...
    if (old != null) old.removeMouseInputListener(listener);

    super.setTitle(title);

    if (title != null) title.addMouseInputListener(listener);
    ...
    public Insets getBorderInsets(Component c) {
      if (getTitle() == null) {
        ...
        switch (getTitleLocation()) {
          case BOTTOM:
            return new Insets(borderSize, borderSize, 0, borderSize);
          case LEFT:
            return new Insets(borderSize, 0, borderSize, borderSize);
          case RIGHT:
            return new Insets(borderSize, borderSize, borderSize, 0);
          case TOP:
            return new Insets(0, borderSize, borderSize, borderSize);
        }
      }
