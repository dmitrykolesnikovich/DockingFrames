...
public class SimpleBubbleColorScheme extends DefaultColorScheme {
  ...
  public static final SimpleBubbleColorScheme BLOPS =
    new SimpleBubbleColorScheme(Color.BLACK, Color.WHITE, new Color(100, 255, 100), new Color(255, 100, 100), Color.DARK_GRAY, 0.3, 0.6,
                                0.9);
  ...
  public static final SimpleBubbleColorScheme BRIGHT =
    new SimpleBubbleColorScheme(Color.LIGHT_GRAY, Color.WHITE, new Color(200, 200, 200), new Color(200, 200, 255), new Color(100, 100, 100),
                                0.3, 0.6, 0.9);
  ...
  public static final ColorScheme LOOK_AND_FEEL = new AbstractColorScheme() {
    ...
    protected void updateUI() {
      ...
      delegate = new SimpleBubbleColorScheme(DockUI.getColor(LookAndFeelColors.TITLE_SELECTION_BACKGROUND),
                                             ...
                                             DockUI.getColor(LookAndFeelColors.TITLE_FOREGROUND), 0.3, 0.6, 0.9);
  ...
  public SimpleBubbleColorScheme(Color color) {
    this(fuller(color, 0.5), brighter(color, 0.9), color, brighter(color, 0.9), darker(color, 0.9), 0.3, 0.6, 0.9);
  }
  ...
  public SimpleBubbleColorScheme(Color active,
                                 ...
                                 double factor,
                                 double factorStrong) {
    this(active, inactive, enabled, selected, disabled, diffMirror(active, 1.0), diffMirror(inactive, 1.0), factorWeak, factor,
         factorStrong);
  }
