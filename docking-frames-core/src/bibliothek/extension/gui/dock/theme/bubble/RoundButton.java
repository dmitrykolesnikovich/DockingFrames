 ...
 */
@ColorCodes({"action.button", "action.button.focus", "action.button.enabled", "action.button.enabled.focus", "action.button.selected",
  "action.button.selected.focus", "action.button.selected.enabled", "action.button.selected.enabled.focus", "action.button.mouse.enabled",
  "action.button.mouse.enabled.focus", "action.button.mouse.selected.enabled", "action.button.mouse.selected.enabled.focus",
  "action.button.pressed.enabled", "action.button.pressed.enabled.focus", "action.button.pressed.selected.enabled",
  "action.button.pressed.selected.enabled.focus",

  "action.button.text", "action.button.text.enabled", "action.button.text.selected", "action.button.text.selected.enabled",
  "action.button.text.mouse.enabled", "action.button.text.mouse.selected.enabled", "action.button.text.pressed.enabled",
...
public class RoundButton extends JComponent implements RoundButtonConnectable {
  ...
  protected AbstractDockColor[] createColors(Dockable dockable, DockAction action) {
    return new AbstractDockColor[]{createColor("action.button", dockable, action, Color.WHITE),
      ...
      createColor("action.button.text", dockable, action, null), createColor("action.button.text.enabled", dockable, action, null),
  ...
  protected void updateColors() {
    ...
    if (enabled && mousePressed) postfix = ".pressed";

    if (enabled && mouseEntered && !mousePressed) postfix = ".mouse";
