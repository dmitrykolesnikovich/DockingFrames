 ...
 */
@ColorCodes({"stack.menu.background.top.mouse", "stack.menu.background.bottom.mouse", "stack.menu.border.mouse",

  "stack.menu.background.top", "stack.menu.background.bottom", "stack.menu.border"})
public class BubbleTabMenu extends ButtonCombinedMenu<RoundButton> {
  ...
  private class Button extends RoundButton {
    ...
    protected AbstractDockColor[] createColors(Dockable dockable, DockAction action) {
      return new AbstractDockColor[]{createColor("stack.menu.background.top.mouse", dockable, action, Color.WHITE),
