 ...
 */
@ColorCodes({"stack.tab.background.top.mouse", "stack.tab.background.bottom.mouse", "stack.tab.border.mouse", "stack.tab.foreground.mouse",

  "stack.tab.background.top", "stack.tab.background.bottom", "stack.tab.border", "stack.tab.foreground",

  "stack.tab.background.top.selected.mouse", "stack.tab.background.bottom.selected.mouse", "stack.tab.border.selected.mouse",
  "stack.tab.foreground.selected.mouse",

  "stack.tab.background.top.selected", "stack.tab.background.bottom.selected", "stack.tab.border.selected", "stack.tab.foreground.selected",

  "stack.tab.background.top.focused.mouse", "stack.tab.background.bottom.focused.mouse", "stack.tab.border.focused.mouse",
  "stack.tab.foreground.focused.mouse",

  "stack.tab.background.top.focused", "stack.tab.background.bottom.focused", "stack.tab.border.focused", "stack.tab.foreground.focused",

  "stack.tab.background.top.disabled", "stack.tab.background.bottom.disabled", "stack.tab.border.disabled",
...
public class BubbleTab extends ConfiguredBackgroundPanel
  ...
  public BubbleTab(BubbleStackDockComponent parent, Dockable dockable) {
    ...
    topSelectedMouse =
      new BubbleTabColor(STATE_SELECTED | STATE_MOUSE, "stack.tab.background.top.selected.mouse", "top", animation, dockable,
                         Color.RED.brighter());
    bottomSelectedMouse =
      new BubbleTabColor(STATE_SELECTED | STATE_MOUSE, "stack.tab.background.bottom.selected.mouse", "bottom", animation, dockable,
                         Color.RED.darker());
    borderSelectedMouse = new BubbleTabColor(STATE_SELECTED | STATE_MOUSE, "stack.tab.border.selected.mouse", "border", animation, dockable,
                                             Color.RED.darker().darker());
    textSelectedMouse =
      new BubbleTabColor(STATE_SELECTED | STATE_MOUSE, "stack.tab.foreground.selected.mouse", "text", animation, dockable, Color.BLACK);
    ...
    bottomSelected =
      new BubbleTabColor(STATE_SELECTED, "stack.tab.background.bottom.selected", "bottom", animation, dockable, Color.RED.darker());
    borderSelected =
      new BubbleTabColor(STATE_SELECTED, "stack.tab.border.selected", "border", animation, dockable, Color.RED.darker().darker());
    textSelected = new BubbleTabColor(STATE_SELECTED, "stack.tab.foreground.selected", "text", animation, dockable, Color.BLACK);

    topFocusedMouse = new BubbleTabColor(STATE_FOCUSED | STATE_MOUSE, "stack.tab.background.top.focused.mouse", "top", animation, dockable,
                                         Color.RED.brighter());
    bottomFocusedMouse =
      new BubbleTabColor(STATE_FOCUSED | STATE_MOUSE, "stack.tab.background.bottom.focused.mouse", "bottom", animation, dockable,
                         Color.RED.darker());
    borderFocusedMouse = new BubbleTabColor(STATE_FOCUSED | STATE_MOUSE, "stack.tab.border.focused.mouse", "border", animation, dockable,
                                            Color.RED.darker().darker());
    textFocusedMouse =
      new BubbleTabColor(STATE_FOCUSED | STATE_MOUSE, "stack.tab.foreground.focused.mouse", "text", animation, dockable, Color.BLACK);

    topFocused = new BubbleTabColor(STATE_FOCUSED, "stack.tab.background.top.focused", "top", animation, dockable, Color.RED.brighter());
    bottomFocused =
      new BubbleTabColor(STATE_FOCUSED, "stack.tab.background.bottom.focused", "bottom", animation, dockable, Color.RED.darker());
    borderFocused =
      new BubbleTabColor(STATE_FOCUSED, "stack.tab.border.focused", "border", animation, dockable, Color.RED.darker().darker());
    textFocused = new BubbleTabColor(STATE_FOCUSED, "stack.tab.foreground.focused", "text", animation, dockable, Color.BLACK);

    topDisabled =
      new BubbleTabColor(STATE_DISABLED, "stack.tab.background.top.disabled", "top", animation, dockable, Color.LIGHT_GRAY.brighter());
    bottomDisabled =
      new BubbleTabColor(STATE_DISABLED, "stack.tab.background.bottom.disabled", "bottom", animation, dockable, Color.LIGHT_GRAY.darker());
    borderDisabled =
      new BubbleTabColor(STATE_DISABLED, "stack.tab.border.disabled", "border", animation, dockable, Color.LIGHT_GRAY.darker().darker());
    textDisabled = new BubbleTabColor(STATE_DISABLED, "stack.tab.foreground.disabled", "text", animation, dockable, Color.BLACK);

    colors = new BubbleTabColor[]{top, bottom, border, text, topMouse, bottomMouse, borderMouse, textMouse, topDisabled, bottomDisabled,
      borderDisabled, textDisabled,

      topSelected, bottomSelected, borderSelected, textSelected, topSelectedMouse, bottomSelectedMouse, borderSelectedMouse,
      textSelectedMouse,

      topFocused, bottomFocused, borderFocused, textFocused, topFocusedMouse, bottomFocusedMouse, borderFocusedMouse, textFocusedMouse};
  ...
  public void setController(DockController controller) {
    if (this.controller != null) this.controller.removeDockableFocusListener(this);
  ...
  private void checkAnimation() {
    ...
    if (!isEnabled()) {
      ...
      if (parent.getSelectedDockable() == dockable) state |= STATE_SELECTED;

      if (mouse) state |= STATE_MOUSE;
