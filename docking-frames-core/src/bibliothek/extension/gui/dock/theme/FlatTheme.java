...
public class FlatTheme extends BasicTheme {
  ...
  public static final PropertyKey<ColorScheme> FLAT_COLOR_SCHEME =
    new PropertyKey<ColorScheme>("dock.ui.FlatTheme.ColorScheme", new DynamicPropertyFactory<ColorScheme>() {
  ...
  public static final PropertyKey<DockActionDistributor> ACTION_DISTRIBUTOR =
    new PropertyKey<DockActionDistributor>("flat.DockActionDistributor",
  ...
  public DisplayerFactory getDisplayFactory(DockStation station) {
    if (station instanceof SplitDockStation) return splitDisplayFactory;
