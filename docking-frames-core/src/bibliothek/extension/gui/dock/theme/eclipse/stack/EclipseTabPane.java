...
public class EclipseTabPane extends CombinedStackDockComponent<EclipseTab, EclipseMenu, EclipseTabInfo> implements BorderedComponent {
  ...
  public void setController(DockController controller) {
    ...
    if (painter != null) painter.setController(controller);
  ...
  public Insets getContentInsets() {
    ...
    Insets result = new Insets(selectionBounds.y, selectionBounds.x, size.height - selectionBounds.y - selectionBounds.height,
