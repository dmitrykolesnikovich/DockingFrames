 ...
 */
@ColorCodes({"stack.tab.top.selected.focused", "stack.tab.bottom.selected.focused", "stack.tab.text", "stack.tab.top.selected",
  "stack.tab.bottom.selected", "stack.tab.top.disabled", "stack.tab.bottom.disabled", "stack.tab.text", "stack.border"})
public class BasicTabDockTitle extends BasicDockTitle {
  ...
  public BasicTabDockTitle(Dockable dockable, DockTitleVersion origin) {
    ...
    addConditionalFont(DockFont.ID_TAB_FOCUSED, TitleFont.KIND_TAB_TITLE_FONT, new Condition() {
      public boolean getState() {
        return isActive();
      }
    }, null);

    addConditionalFont(DockFont.ID_TAB_SELECTED, TitleFont.KIND_TAB_TITLE_FONT, new Condition() {
      public boolean getState() {
        return selected;
      }
    }, null);

    addConditionalFont(DockFont.ID_TAB_UNSELECTED, TitleFont.KIND_TAB_TITLE_FONT, new Condition() {
      public boolean getState() {
        return !isActive();
      }
    }, null);
