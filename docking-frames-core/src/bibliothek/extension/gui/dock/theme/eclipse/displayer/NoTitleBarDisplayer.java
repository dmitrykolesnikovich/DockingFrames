...
public class NoTitleBarDisplayer extends BasicDockableDisplayer implements DockableDisplayer, InvisibleTabPane, BorderedComponent {
  ...
  public void setBorder(Dockable dockable, Border border) {
    if (dockable != getDockable()) throw new IllegalArgumentException("unknown dockable: " + dockable);
  ...
  public void setController(DockController controller) {
    ...
    if (painter != null) painter.setProperties(controller == null ? null : controller.getProperties());

    if (observer != null) observer.setController(controller);

    if (invisibleTab != null) invisibleTab.setController(controller);
