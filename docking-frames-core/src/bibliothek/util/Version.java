...
public final class Version implements Comparable<Version> {
  ...
  public Version(int major, int minor, int mikro, String add) {
    if (major < 0) throw new IllegalArgumentException("major must not be smaller than 0");
    if (minor < 0) throw new IllegalArgumentException("minor must not be smaller than 0");
    if (mikro < 0) throw new IllegalArgumentException("mikro must not be smaller than 0");
    if (add == null) add = "";
  ...
  public static Version read(DataInputStream in) throws IOException {
    ...
    if (version != 1) throw new IOException("Unknown format for version");
  ...
  public boolean equals(Object obj) {
    ...
    if (add == null) {
      if (other.add != null) return false;
    }
    else if (!add.equals(other.add)) return false;
    if (major != other.major) return false;
    if (mikro != other.mikro) return false;
