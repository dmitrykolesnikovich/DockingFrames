...
public interface TabPane {
  ...
  public static final PropertyKey<TabLayoutManager> LAYOUT_MANAGER =
    new PropertyKey<TabLayoutManager>("dock.tabpane.layout_manager", new DynamicPropertyFactory<TabLayoutManager>() {
  ...
  public static final PropertyKey<Boolean> USE_SMALL_MINIMUM_SIZE =
    new PropertyKey<Boolean>("dock.tabpane.layout_manager.small", new ConstantPropertyFactory<Boolean>(true), true);
