...
public class TabComponentLayoutManager implements LayoutManager {
  ...
  public Dimension preferredLayoutSize(Container parent) {
    ...
    if (orientation.isHorizontal()) {
      result = new Dimension(size.width + 2 * freeSpaceToSideBorder + labelInsets.left + labelInsets.right,
      ...
      if (actions.hasActions()) {
        ...
        result.height =
          Math.max(result.height, size.height + freeSpaceToOpenSide + freeSpaceToParallelBorder + actionInsets.top + actionInsets.bottom);
      }
      else {
      ...
      result = new Dimension(size.width + freeSpaceToOpenSide + freeSpaceToParallelBorder + labelInsets.left + labelInsets.right,
      ...
      if (actions.hasActions()) {
        ...
        result.width =
          Math.max(result.width, size.width + freeSpaceToOpenSide + freeSpaceToParallelBorder + actionInsets.left + actionInsets.right);
      }
      else {
  ...
  public void layoutContainer(Container parent) {
    ...
    if (showActions) {
      ...
      actionsSize = new Dimension(actionsSize.width + actionInsets.left + actionInsets.right,
      ...
      if (configuration.isHiddenActionUsingSpace()) {
        actionsSize = new Dimension(actionInsets.right, actionInsets.bottom);
      }
      else {
    ...
    switch (orientation) {
      case TOP_OF_DOCKABLE:
        label.setBounds(freeSpaceToSideBorder + labelInsets.left, freeSpaceToOpenSide + labelInsets.top,
                        labelSize(parent, width - 2 * freeSpaceToSideBorder - actionsSize.width - labelInsets.left - labelInsets.right,
                                  freeSpaceToSideBorder + labelInsets.left, showActions),
        ...
        if (showActions) {
          ...
          actions.setBounds(Math.max(0, width - freeSpaceToOpenSide - actionsSize.width + actionInsets.left),
        ...
        break;
      case BOTTOM_OF_DOCKABLE:
        label.setBounds(freeSpaceToSideBorder + labelInsets.left, freeSpaceToParallelBorder + labelInsets.top,
                        labelSize(parent, width - 2 * freeSpaceToSideBorder - actionsSize.width - labelInsets.left - labelInsets.right,
                                  freeSpaceToSideBorder + labelInsets.left, showActions),
                        height - freeSpaceToOpenSide - freeSpaceToParallelBorder - labelInsets.top - labelInsets.bottom);
        if (showActions) {
        ...
        break;
      case RIGHT_OF_DOCKABLE:
        label.setBounds(freeSpaceToParallelBorder + labelInsets.left, freeSpaceToSideBorder + labelInsets.top,
                        width - freeSpaceToOpenSide - freeSpaceToParallelBorder - labelInsets.left - labelInsets.right,
                        labelSize(parent, height - 2 * freeSpaceToSideBorder - actionsSize.height - labelInsets.top - labelInsets.bottom,
                                  freeSpaceToSideBorder + labelInsets.top, showActions));
        if (showActions) {
          ...
          actions.setBounds(freeSpaceToParallelBorder + delta / 2 + actionInsets.left,
        ...
        break;
      case LEFT_OF_DOCKABLE:
        label.setBounds(freeSpaceToOpenSide + labelInsets.left, freeSpaceToSideBorder + labelInsets.top,
                        width - freeSpaceToOpenSide - freeSpaceToParallelBorder - labelInsets.left - labelInsets.right,
                        labelSize(parent, height - 2 * freeSpaceToSideBorder - actionsSize.height - labelInsets.top - labelInsets.bottom,
                                  freeSpaceToSideBorder + labelInsets.top, showActions));
        if (showActions) {
          ...
          actions.setBounds(width - actionsWidth - freeSpaceToParallelBorder - delta / 2 + actionInsets.left,
                            Math.max(0, height - freeSpaceToOpenSide - actionsSize.height + actionInsets.top),
                            actionsWidth - actionInsets.left - actionInsets.right,
                            actionsSize.height - actionInsets.top - actionInsets.bottom);
        }
  ...
  protected boolean shouldShowActions(Container parent) {
    ...
    if (orientation.isHorizontal()) {
      ...
      int labelDelta = freeSpaceToSideBorder +
