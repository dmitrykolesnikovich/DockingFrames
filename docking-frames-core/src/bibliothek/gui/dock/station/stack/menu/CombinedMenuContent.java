...
public interface CombinedMenuContent {
   ...
   */
  public static final PropertyKey<CombinedMenuContent> MENU_CONTENT =
    new PropertyKey<CombinedMenuContent>("dock.CombinedMenuContent", new DynamicPropertyFactory<CombinedMenuContent>() {
