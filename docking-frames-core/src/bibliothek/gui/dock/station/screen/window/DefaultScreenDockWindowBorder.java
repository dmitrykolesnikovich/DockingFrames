 ...
 */
@ColorCodes({"station.screen.border", "station.screen.border.line", "station.screen.border.line.highlight.inner",
  "station.screen.border.line.highlight.outer", "station.screen.border.line.shadow.inner", "station.screen.border.line.shadow.outer",
  "station.screen.border.highlight.inner", "station.screen.border.highlight.outer", "station.screen.border.shadow.inner",
  "station.screen.border.shadow.outer", "station.screen.border.hover", "station.screen.border.highlight.inner.hover",
  "station.screen.border.highlight.outer.hover", "station.screen.border.shadow.inner.hover", "station.screen.border.shadow.outer.hover",
  "station.screen.border.selected", "station.screen.border.highlight.inner.selected", "station.screen.border.highlight.outer.selected",
  "station.screen.border.shadow.inner.selected", "station.screen.border.shadow.outer.selected"})
public class DefaultScreenDockWindowBorder implements ScreenDockWindowBorder {
  ...
  public DefaultScreenDockWindowBorder(ScreenDockWindow window, JComponent target) {
    ...
    colors = new BorderColor[]{colorLine, colorLineHighlightInner, colorLineHighlightOuter, colorLineShadowInner, colorLineShadowOuter,

      color, colorHighlightInner, colorHighlightOuter, colorShadowInner, colorShadowOuter,

      colorHover, colorHighlightInnerHover, colorHighlightOuterHover, colorShadowInnerHover, colorShadowOuterHover,

      colorSelected, colorHighlightInnerSelected, colorHighlightOuterSelected, colorShadowInnerSelected, colorShadowOuterSelected};
  }
