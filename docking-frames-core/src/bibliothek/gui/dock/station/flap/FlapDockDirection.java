...
public class FlapDockDirection extends SimpleMenuAction implements ListeningDockAction {
  ...
  public FlapDockDirection() {
    ...
    icons = new FlapIcon[]{new FlapIcon("flap.direction"), new FlapIcon("flap.south"), new FlapIcon("flap.east"), new FlapIcon("flap.west"),
      new FlapIcon("flap.north"), new FlapIcon("flap.auto")};

    texts = new DockActionText[]{flapDirection, flapDirectionTooltip, flapDirectionNorth, flapDirectionNorthTooltip, flapDirectionSouth,
      flapDirectionSouthTooltip, flapDirectionEast, flapDirectionEastTooltip, flapDirectionWest, flapDirectionWestTooltip,
      flapDirectionCenter, flapDirectionCenterTooltip};
  ...
  private FlapDockStation getStation(Dockable dockable) {
    if (dockable instanceof FlapDockStation) return (FlapDockStation)dockable;
  ...
  private class FlapIcon extends DockActionIcon {
    ...
    protected void changed(Icon oldValue, Icon icon) {
      ...
      else if (key.equals("flap.auto")) center.setIcon(icon);
    }
  }
  ...
  private class DirectedArrow extends SimpleSelectableAction.Radio {
    ...
    public boolean isSelected(Dockable dockable) {
      ...
      if (direction == null) return station.isAutoDirection();
