...
public interface DockTitle extends DockElementRepresentative, DockComponentRoot {
  ...
  public static final PropertyKey<OrientationToRotationStrategy> ORIENTATION_STRATEGY =
    new PropertyKey<OrientationToRotationStrategy>("DockTitle.orientation", new ConstantPropertyFactory<OrientationToRotationStrategy>(
      OrientationToRotationStrategy.DEFAULT), true);
