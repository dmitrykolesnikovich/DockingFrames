...
public class DefaultLayoutChangeStrategy implements LayoutChangeStrategy {
   ...
   */
  protected void applyLayout(DockFrontendInternals frontend, DockSituation situation, SettingAccess setting, boolean entry)
    throws IOException, XException {
   ...
   * @throws XException  if the layout cannot be converted
   */
  protected void applyInvisibleLayout(DockFrontendInternals frontend, DockSituation situation, SettingAccess setting)
    throws IOException, XException {
    DockFrontend dockFrontend = frontend.getFrontend();
    MissingDockableStrategy missingDockable = frontend.getMissingDockableStrategy();
