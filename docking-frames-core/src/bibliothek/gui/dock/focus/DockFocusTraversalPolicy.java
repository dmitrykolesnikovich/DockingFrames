...
public class DockFocusTraversalPolicy extends FocusTraversalPolicy {
  ...
  protected Component after(Component component) {
    ...
    if (providerPolicy == null) return null;
  ...
  public Component getComponentBefore(Container container, Component component) {
    ...
    try {
      ...
      while (true) {
        if (previous == component) return null;
        ...
        if (accept(previous)) return previous;
  ...
  public Component getDefaultComponent(Container container) {
    ...
    try {
      ...
      if (component == container) return component;
