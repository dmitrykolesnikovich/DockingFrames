...
public abstract class DisplayerRequest extends ResourceRequest<DockableDisplayer> {
  ...
  public void setController(DockController controller) {
    if (this.controller != controller) {
      ...
      if (controller != null) {
        extensions = controller.getExtensions().share(
          new ExtensionName<DisplayerFactory>(DisplayerFactory.DISPLAYER_EXTENSION, DisplayerFactory.class,
                                              DisplayerFactory.DISPLAYER_EXTENSION_ID, displayerId));
        extensions.bind();
      }
    }
  }
