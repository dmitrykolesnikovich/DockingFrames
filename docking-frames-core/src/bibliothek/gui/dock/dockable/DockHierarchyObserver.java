...
public class DockHierarchyObserver implements DockHierarchyListener {
  ...
  public void update() {
    ...
    if (old != parent) {
      if (old != null && old.asDockable() != null) old.asDockable().removeDockHierarchyListener(this);

      if (parent != null && parent.asDockable() != null) parent.asDockable().addDockHierarchyListener(this);
