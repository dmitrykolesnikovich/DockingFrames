...
public abstract class AbstractUIValue<V, U extends UIValue<V>> implements UIValue<V> {
  ...
  public AbstractUIValue(String id, Path kind, V backup) {
    if (id == null) throw new IllegalArgumentException("id must no be null");
  ...
  public void setManager(UIProperties<V, U, ?> manager) {
    if (manager != this.manager) {
      U me = me();
      if (this.manager != null) this.manager.remove(me);

      this.manager = manager;

      if (this.manager != null) this.manager.add(id, kind, me);
    }
  }
   ...
   */
  public V value() {
    if (overrideNull || override != null) return override;
