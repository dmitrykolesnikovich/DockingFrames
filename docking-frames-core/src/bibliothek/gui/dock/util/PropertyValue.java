...
public abstract class PropertyValue<A> {
  ...
  public PropertyValue(PropertyKey<A> key, DockController controller) {
    ...
    listener = new DockPropertyListener<A>() {
      public void propertyChanged(DockProperties properties, PropertyKey<A> property, A oldValue, A newValue) {
        if (value == null) valueChanged(oldValue, newValue);
      }
    };
  ...
  public void setProperties(DockProperties properties) {
    if (value != null) {
      ...
      if (this.properties != null) this.properties.removeListener(key, listener);

      this.properties = properties;

      if (properties != null) properties.addListener(key, listener);
  ...
  public void setValue(A value) {
    if (properties != null) {
      ...
      else if (this.value != null && value == null) properties.addListener(key, listener);
    }
  ...
  public boolean isAnyValueSet() {
    ...
    if (properties != null) {
      if (properties.isSet(key)) return true;
    }
