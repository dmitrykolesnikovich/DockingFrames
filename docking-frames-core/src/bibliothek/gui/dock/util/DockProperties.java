  ...
  private class Entry<A> {
    ...
    public void setValue(A value, Priority priority) {
      ...
      if ((oldValue == null && newValue != null) ||
        ...
        for (DockPropertyListener<A> listener : (DockPropertyListener<A>[])listeners
          .toArray(new DockPropertyListener<?>[listeners.size()])) {
    ...
    public boolean removeable() {
      ...
      if (defaultValueSet || value.isSomethingSet()) return false;
