...
public class ViewTarget<A> {
   ...
   */
  public static final ViewTarget<MenuViewItem<JComponent>> MENU = new ViewTarget<MenuViewItem<JComponent>>("target MENU");

  /**
   * A target for an item shown on a {@link DockTitle}
   */
  public static final ViewTarget<BasicTitleViewItem<JComponent>> TITLE = new ViewTarget<BasicTitleViewItem<JComponent>>("target TITLE");

  /**
   * A target aiming to a {@link DropDownAction}
   */
  public static final ViewTarget<DropDownViewItem> DROP_DOWN = new ViewTarget<DropDownViewItem>("target DROP DOWN");
