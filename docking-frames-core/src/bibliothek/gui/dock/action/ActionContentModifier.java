...
public class ActionContentModifier {
  ...
  public static final ActionContentModifier DISABLED_HOVER_VERTICAL =
    new ActionContentModifier("dock.disabled.hover.vertical", false, false, true, DISABLED_HOVER, DISABLED_VERTICAL);
  /**
  ...
  public static final ActionContentModifier DISABLED_HOVER_HORIZONTAL =
    new ActionContentModifier("dock.disabled.hover.horizontal", false, true, false, DISABLED_HOVER, DISABLED_HORIZONTAL);
  ...
  public static final ActionContentModifier DISABLED_PRESSED_VERTICAL =
    new ActionContentModifier("dock.disabled.pressed.vertical", false, false, true, DISABLED_PRESSED, DISABLED_VERTICAL);
  /**
  ...
  public static final ActionContentModifier DISABLED_PRESSED_HORIZONTAL =
    new ActionContentModifier("dock.disabled.pressed.horizontal", false, true, false, DISABLED_PRESSED, DISABLED_HORIZONTAL);
