...
public class DefaultDockActionSource extends AbstractDockActionSource {
  ...
  public Iterator<DockAction> iterator() {
    return new Iterator<DockAction>() {
      ...
      public void remove() {
        if (removed) throw new IllegalStateException("Next not yet called or remove already called");
  ...
  public void remove(int index, int length) {
    ...
    if (index + length > getDockActionCount()) throw new IllegalArgumentException("index + length too great");
