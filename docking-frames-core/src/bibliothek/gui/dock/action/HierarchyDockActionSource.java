...
public class HierarchyDockActionSource extends AbstractDockActionSource {
  ...
  public void update() {
    ...
    if (oldSize > 0) fireRemoved(0, oldSize - 1);

    DockController controller = dockable.getController();
    if (controller != null) source = controller.listOffers(dockable);
  ...
  public void addDockActionSourceListener(DockActionSourceListener listener) {
    if (listeners.isEmpty() && source != null) source.addDockActionSourceListener(this.listener);
  ...
  public void removeDockActionSourceListener(DockActionSourceListener listener) {
    ...
    if (listeners.isEmpty() && source != null) source.removeDockActionSourceListener(this.listener);
  }
