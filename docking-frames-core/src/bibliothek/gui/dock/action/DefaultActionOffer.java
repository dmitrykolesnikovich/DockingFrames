...
public class DefaultActionOffer implements ActionOffer {
  ...
  private LocationHint.Hint[] hints =
    new LocationHint.Hint[]{LocationHint.LEFT_OF_ALL, LocationHint.VERY_LEFT, LocationHint.LEFT, LocationHint.LITTLE_LEFT,
      LocationHint.MIDDLE, LocationHint.LITTLE_RIGHT, LocationHint.RIGHT, LocationHint.VERY_RIGHT, LocationHint.RIGHT_OF_ALL};
  ...
  public DefaultActionOffer(LocationHint.Origin... origins) {
    if (origins == null) throw new IllegalArgumentException("Elements must not be null.");
  ...
  public void setOrigins(LocationHint.Origin[] origins) {
    if (origins == null) throw new IllegalArgumentException("value must not be null");
    this.origins = origins;
  }
  ...
  public void setHints(LocationHint.Hint[] hints) {
    if (hints == null) throw new IllegalArgumentException("value must not be null");
    this.hints = hints;
  }
  ...
  public DockActionSource getSource(Dockable dockable,
    ...
    if (guards != null) {
      for (DockActionSource guard : guards) {
        if (guard != null) sources.add(guard);
      }
    }

    if (parent != null) sources.add(parent);

    if (parents != null) {
      for (DockActionSource action : parents) {
        if (action != null) sources.add(action);
      }
    }
