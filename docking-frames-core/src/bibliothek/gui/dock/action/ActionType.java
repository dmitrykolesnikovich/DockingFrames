...
public class ActionType<D extends DockAction> {
   ...
   */
  public static final ActionType<ButtonDockAction> BUTTON = new ActionType<ButtonDockAction>("action type BUTTON");
  /**
   * The action behaves like a checkbox: when it is triggered,
   * it changes it's state from selected to unselected, or vice versa.
   */
  public static final ActionType<SelectableDockAction> CHECK = new ActionType<SelectableDockAction>("action type CHECK");
  /**
   ...
   */
  public static final ActionType<SelectableDockAction> RADIO = new ActionType<SelectableDockAction>("action type RADIO");

  /**
   * The action is a group of other actions which are shown as soon
   * as someone triggers the action.
   */
  public static final ActionType<MenuDockAction> MENU = new ActionType<MenuDockAction>("action type MENU");

  /**
   * Represents a separator.
   */
  public static final ActionType<SeparatorAction> SEPARATOR = new ActionType<SeparatorAction>("action type SEPARATOR");

  /**
   * Represents a drop down action.
   */
  public static final ActionType<DropDownAction> DROP_DOWN = new ActionType<DropDownAction>("action type DROP DOWN");
