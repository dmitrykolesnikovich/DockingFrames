...
public class DoubleClickController {
   ...
   */
  private LocatedListenerList<DoubleClickListener> observers = new LocatedListenerList<DoubleClickListener>();
  ...
  public void send(Dockable dockable, MouseEvent event) {
    ...
    if (event.getClickCount() != 2) throw new IllegalArgumentException("click count must be equal to 2");
