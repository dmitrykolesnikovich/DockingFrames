...
public interface DockRelocatorMode {
   ...
   */
  public static final PropertyKey<ModifierMask> SCREEN_MASK = new PropertyKey<ModifierMask>("DockRelocatorMode screen mask",
   ...
   */
  public static final PropertyKey<ModifierMask> NO_COMBINATION_MASK = new PropertyKey<ModifierMask>("DockRelocatorMode no combination",
                                                                                                    new ConstantPropertyFactory<ModifierMask>(
                                                                                                      new ModifierMask(
