...
public class BasicTheme implements DockTheme {
  ...
  public static final PropertyKey<ColorScheme> BASIC_COLOR_SCHEME =
    new PropertyKey<ColorScheme>("dock.ui.BasicTheme.ColorScheme", new DynamicPropertyFactory<ColorScheme>() {
  ...
  protected void install(DockController controller) {
    if (this.controller != null) throw new IllegalStateException("Theme is already in use");
  ...
  public void uninstall(DockController controller) {
    if (this.controller != controller) throw new IllegalArgumentException("Trying to uninstall a controller which is not installed");
