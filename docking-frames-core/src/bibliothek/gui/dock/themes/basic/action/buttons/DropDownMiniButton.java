...
public class DropDownMiniButton extends MiniButton<BasicDropDownButtonModel> {
  ...
  public void doLayout() {
    ...
    if (getModel().getOrientation().isHorizontal()) {
      ...
      content.setBounds(insets.left + 1, insets.top, getWidth() - insets.left - 2 * insets.right - 1 - dropWidth,
                        getHeight() - insets.top - insets.bottom);
    }
    else {
      int dropHeight = dropIcon.getIconHeight();
      content.setBounds(insets.left, insets.top + 1, getWidth() - insets.left - insets.right,
