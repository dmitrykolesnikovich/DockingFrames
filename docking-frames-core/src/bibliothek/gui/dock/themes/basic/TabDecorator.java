...
public class TabDecorator implements BasicDockableDisplayerDecorator, StackDockComponentParent {
  ...
  protected void fireMoveableElementChanged() {
    for (BasicDockableDisplayerDecoratorListener listener : listeners
      .toArray(new BasicDockableDisplayerDecoratorListener[listeners.size()])) {
  ...
  public int indexOf(Dockable dockable) {
    if (this.dockable == dockable) return 0;
    return -1;
  }
