 ...
 */
@ColorCodes({"title.station.active", "title.station.active.text", "title.station.inactive", "title.station.inactive.text",
...
public class BasicStationTitle extends AbstractDockTitle {
  ...
  public Dimension getPreferredSize() {
    ...
    return new Dimension(Math.max(preferredDimension, size.width), Math.max(preferredDimension, size.height));
  }
