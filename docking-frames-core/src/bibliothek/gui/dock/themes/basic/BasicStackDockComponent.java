 ...
 */
@ColorCodes({"stack.tab.foreground", "stack.tab.foreground.selected", "stack.tab.foreground.focused", "stack.tab.background",
...
public class BasicStackDockComponent extends DefaultStackDockComponent {
  ...
  protected class BasicTab extends DefaultStackDockComponent.Tab implements DockableFocusListener {
    ...
    public BasicTab(Dockable dockable) {
      ...
      colors = new TabColor[]{colorForeground = new BasicTabColor("stack.tab.foreground"),
    ...
    public void setController(DockController controller) {
      ...
      if (controller != null) controller.addDockableFocusListener(this);
