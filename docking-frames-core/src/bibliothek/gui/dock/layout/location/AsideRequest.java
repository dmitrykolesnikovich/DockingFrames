...
public interface AsideRequest {
   ...
   */
  public static final PropertyKey<AsideRequestFactory> REQUEST_FACTORY =
    new PropertyKey<AsideRequestFactory>("dock.AsideRequestFactory", new DynamicPropertyFactory<AsideRequestFactory>() {
