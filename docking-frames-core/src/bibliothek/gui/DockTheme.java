...
public interface DockTheme {
   ...
   */
  public static final PropertyKey<SpanFactory> SPAN_FACTORY =
    new PropertyKey<SpanFactory>("span factory", new ConstantPropertyFactory<SpanFactory>(new DefaultSpanFactory()), true);
  /**
   ...
   * value will be derived from the current {@link DockTheme}.
   */
  public static final PropertyKey<StationPaint> STATION_PAINT =
    new PropertyKey<StationPaint>("dock.paint", new DynamicPropertyFactory<StationPaint>() {
   ...
   * value will be derived from the current {@link DockTheme}.
   */
  public static final PropertyKey<DisplayerFactory> DISPLAYER_FACTORY =
    new PropertyKey<DisplayerFactory>("dock.displayerFactory", new DynamicPropertyFactory<DisplayerFactory>() {
   ...
   */
  public static final PropertyKey<DockableMovingImageFactory> DOCKABLE_MOVING_IMAGE_FACTORY =
    new PropertyKey<DockableMovingImageFactory>("dock.movingImageFactory", new DynamicPropertyFactory<DockableMovingImageFactory>() {
   ...
   */
  public static final PropertyKey<DockableSelection> DOCKABLE_SELECTION =
    new PropertyKey<DockableSelection>("dock.dockableSelection", new DynamicPropertyFactory<DockableSelection>() {
