...
public class TestToolbarDockAndStack {
  ...
  public static void main(String[] args) {
     ...
     * */
    final ToolbarContainerDockStation toolbarStationWest = new ToolbarContainerDockStation(Orientation.VERTICAL);
    pane.add(toolbarStationWest.getComponent(), BorderLayout.WEST);
    final ToolbarContainerDockStation toolbarStationNorth = new ToolbarContainerDockStation(Orientation.HORIZONTAL);
    ...
    final ToolbarItemDockable dockable5 = new ToolbarItemDockable(new JButton("One"));
    group2.drop(dockable5);
    final ToolbarItemDockable dockable6 = new ToolbarItemDockable(new JButton("One"));
    group2.drop(dockable6);
    final ToolbarDockStation group3 = new ToolbarDockStation();
    final ToolbarItemDockable dockable7 = new ToolbarItemDockable(new JButton("One"));
    group3.drop(dockable7);
    final ToolbarItemDockable dockable8 = new ToolbarItemDockable(new JButton("One"));
