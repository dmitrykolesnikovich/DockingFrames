...
public class TestToolbarContainerDockStation {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("###############################################################");
    final ToolbarContainerDockStation toolbarStationWest = new ToolbarContainerDockStation(Orientation.HORIZONTAL);
    controller.add(toolbarStationWest);
    pane.add(toolbarStationWest.getComponent(), BorderLayout.NORTH);
    final ToolbarContainerDockStation toolbarStationEast = new ToolbarContainerDockStation(Orientation.VERTICAL);
