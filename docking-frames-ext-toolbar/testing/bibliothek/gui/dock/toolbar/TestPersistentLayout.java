...
public class TestPersistentLayout {
  public static void main(String[] args) {
    ...
    ImageIcon icon = new ImageIcon(TestPersistentLayout.class.getResource("/resources/film.png"));
    final ToolbarItemDockable button00 = new ToolbarItemDockable(new JButton(icon));
    ...
    final ScreenDockStation screenStation = new ScreenDockStation(windowProvider);
    screenStation.setShowing(true);
    frontend.addRoot("rootScreen", screenStation);

    // Disable the expand state action button
    frontend.getController().getProperties().set(ExpandableToolbarItemStrategy.STRATEGY, new DefaultExpandableToolbarItemStrategy() {
      @Override
    ...
    frontend.getController().getThemeManager().setStationPaint(ThemeManager.STATION_PAINT + ".toolbar", paint);

    icon = new ImageIcon(TestPersistentLayout.class.getResource("/resources/film.png"));
    ...
    final ToolbarContainerDockStation rootWest = new ToolbarContainerDockStation(Orientation.VERTICAL);
    rootWest.setDockablesMaxNumber(1);
    final ToolbarContainerDockStation rootNorth = new ToolbarContainerDockStation(Orientation.HORIZONTAL);
