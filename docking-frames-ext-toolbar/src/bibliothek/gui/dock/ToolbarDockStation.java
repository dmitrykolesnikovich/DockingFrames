...
public class ToolbarDockStation extends AbstractToolbarDockStation {
  ...
  public static final PropertyKey<Integer> GAP =
    new PropertyKey<Integer>("dock.toolbar.gap", new ConstantPropertyFactory<Integer>(Integer.valueOf(2)), true);
  ...
  public static final PropertyKey<Integer> SIDE_GAP =
    new PropertyKey<Integer>("dock.toolbar.sidegap", new ConstantPropertyFactory<Integer>(Integer.valueOf(4)), true);
