...
public class ToolbarGroupDockStation extends AbstractToolbarDockStation {
  ...
  public static final PropertyKey<ColumnScrollBarFactory> SCROLLBAR_FACTORY =
    new PropertyKey<ColumnScrollBarFactory>("dock.scrollbarFactory",
                                            new ConstantPropertyFactory<ColumnScrollBarFactory>(SlimScrollbar.FACTORY), true);
  ...
  public static final PropertyKey<ToolbarGroupDividerStrategyFactory> DIVIDER_STRATEGY_FACTORY =
    new PropertyKey<ToolbarGroupDividerStrategyFactory>("dock.toolbarGroupDividerStrategy",
                                                        new ConstantPropertyFactory<ToolbarGroupDividerStrategyFactory>(
                                                          DefaultToolbarGroupDividierStrategy.FACTORY), true);
   ...
   */
  private PropertyValue<ToolbarGroupDividerStrategyFactory> dividerStrategyFactory =
    new PropertyValue<ToolbarGroupDividerStrategyFactory>(DIVIDER_STRATEGY_FACTORY) {
      @Override
  ...
  public DockStationDropLayer[] getLayers() {
    return new DockStationDropLayer[]{new ToolbarGroupInnerLayer(this, mainPanel.dockablePane),
  ...
  @Override
  @Todo(compatibility = Compatibility.COMPATIBLE, priority = Priority.ENHANCEMENT, target = Version.VERSION_1_1_2, description = "Implement this feature")
  ...
  protected class OverpaintablePanelBase extends SecureContainer {
    ...
    public void updateAlignment() {
      ...
      if (orientation != null) {
        ...
        layoutManager =
          new ToolbarGridLayoutManager<StationChildHandle>(dockablePane, orientation, dockables, ToolbarGroupDockStation.this) {
            @Override
