...
public abstract class AbstractToolbarDockStation extends AbstractDockableStation implements OrientedDockStation, ExpandableToolbarItem {
  ...
  public static final PropertyKey<Boolean> ON_CONFLICT_ENABLE =
    new PropertyKey<Boolean>("ExpandableToolbarGroupActions.on_conflict_enable", new ConstantPropertyFactory<Boolean>(Boolean.TRUE), true);
  /**
   ...
   */
  private PropertyValue<ExpandableToolbarItemStrategy> expandableStategy =
