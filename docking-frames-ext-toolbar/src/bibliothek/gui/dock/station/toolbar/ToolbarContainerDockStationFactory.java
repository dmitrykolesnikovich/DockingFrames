...
public class ToolbarContainerDockStationFactory
  ...
  @Override
  public ToolbarContainerDockPerspective layoutPerspective(ToolbarContainerDockStationLayout layout,
                                                           Map<Integer, PerspectiveDockable> children) {
    return new ToolbarContainerDockPerspective(layout, children);
  }

  @Override
  public void layoutPerspective(ToolbarContainerDockPerspective perspective,
                                ToolbarContainerDockStationLayout layout,
                                Map<Integer, PerspectiveDockable> children) {
