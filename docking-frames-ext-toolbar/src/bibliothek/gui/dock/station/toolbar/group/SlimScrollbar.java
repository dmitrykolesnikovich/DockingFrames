...
public class SlimScrollbar extends JComponent implements ColumnScrollBar, Adjustable {
  ...
  public SlimScrollbar() {
    ...
    model.addChangeListener(new ChangeListener() {
      ...
      public void stateChanged(ChangeEvent e) {
        AdjustmentEvent event = new AdjustmentEvent(SlimScrollbar.this, 0, 0, getValue());
    ...
    MouseAdapter adapter = new MouseAdapter() {
      ...
      public void mouseReleased(MouseEvent e) {
        mousePressed =
          (e.getModifiersEx() & (MouseEvent.BUTTON1_DOWN_MASK | MouseEvent.BUTTON2_DOWN_MASK | MouseEvent.BUTTON3_DOWN_MASK)) != 0;
  ...
  protected void paintComponent(Graphics g) {
    ...
    if (hover) {
      if (orientation == Orientation.HORIZONTAL) {
        g2D.setPaint(new GradientPaint(new Point(value, 0), new Color(baseColorValue + 120, baseColorValue + 120, baseColorValue + 120),
                                       new Point(value, 6), new Color(baseColorValue + 40, baseColorValue + 40, baseColorValue + 40)));
        rec = new Rectangle2D.Double(value, 0, thumb, 6);
      }
      else {
        g2D.setPaint(new GradientPaint(new Point(0, value), new Color(baseColorValue + 120, baseColorValue + 120, baseColorValue + 120),
                                       new Point(6, value), new Color(baseColorValue + 40, baseColorValue + 40, baseColorValue + 40)));
        rec = new Rectangle2D.Double(0, value, 6, thumb);
      }
    }
    else {
      if (orientation == Orientation.HORIZONTAL) {
        g2D.setPaint(new GradientPaint(new Point(value, 0), new Color(baseColorValue + 90, baseColorValue + 90, baseColorValue + 90),
                                       new Point(value, 6), new Color(baseColorValue, baseColorValue, baseColorValue)));
        rec = new Rectangle2D.Double(value, 0, thumb, 6);
      }
      else {
        g2D.setPaint(new GradientPaint(new Point(0, value), new Color(baseColorValue + 90, baseColorValue + 90, baseColorValue + 90),
                                       new Point(6, value), new Color(baseColorValue, baseColorValue, baseColorValue)));
        rec = new Rectangle2D.Double(0, value, 6, thumb);
      }
