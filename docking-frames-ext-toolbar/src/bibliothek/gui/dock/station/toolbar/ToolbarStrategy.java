...
public interface ToolbarStrategy {
   ...
   */
  public static final PropertyKey<ToolbarStrategy> STRATEGY =
    new PropertyKey<ToolbarStrategy>("dock.toolbarStrategy", new ConstantPropertyFactory<ToolbarStrategy>(new DefaultToolbarStrategy()),
                                     true);
