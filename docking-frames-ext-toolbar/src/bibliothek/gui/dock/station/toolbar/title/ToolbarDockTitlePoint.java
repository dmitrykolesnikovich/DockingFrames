...
public class ToolbarDockTitlePoint extends AbstractDockTitle {
  ...
  public static DockTitleFactory createFactory(final Color backgroundColor, final Color pointColor) {
    return new DockTitleFactory() {
      ...
      public void request(DockTitleRequest request) {
        request.answer(new ToolbarDockTitlePoint(request.getVersion(), request.getTarget(), backgroundColor, pointColor));
      }
  ...
  public static DockTitleFactory createFactory() {
    return new DockTitleFactory() {
      ...
      @Override
      public void request(DockTitleRequest request) {
        request.answer(new ToolbarDockTitlePoint(request.getVersion(), request.getTarget()));
      }
