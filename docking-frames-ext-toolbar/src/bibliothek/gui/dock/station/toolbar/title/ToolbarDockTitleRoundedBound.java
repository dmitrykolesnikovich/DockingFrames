...
public class ToolbarDockTitleRoundedBound extends AbstractDockTitle {
  ...
  public ToolbarDockTitleRoundedBound(DockTitleVersion origin, Dockable dockable, Color color) {
  ...
  public static DockTitleFactory createFactory(final Color color) {
    return new DockTitleFactory() {
      ...
      public void request(DockTitleRequest request) {
        request.answer(new ToolbarDockTitleRoundedBound(request.getVersion(), request.getTarget(), color));
      }
