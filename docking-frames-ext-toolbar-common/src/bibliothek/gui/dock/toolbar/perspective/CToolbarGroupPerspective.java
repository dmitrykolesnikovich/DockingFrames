...
public class CToolbarGroupPerspective {
   ...
   */
  private Map<ToolbarColumn<PerspectiveDockable, PerspectiveDockable>, Column> columns =
    new HashMap<ToolbarColumn<PerspectiveDockable, PerspectiveDockable>, CToolbarGroupPerspective.Column>();
