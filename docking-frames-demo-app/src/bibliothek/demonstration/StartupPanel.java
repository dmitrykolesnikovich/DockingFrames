...
public class StartupPanel extends JPanel {
  ...
  public StartupPanel() {
    ...
    panel.add(text,
              new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 10, 10, 10),
                                     0, 0));
    panel.add(new Animation(),
              new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 10, 10, 10),
                                     0, 0));
  ...
  private class Animation extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
      ...
      for (int i = 0; i < POINTS; i++) {
        ...
        g2.setColor(Color.WHITE);
        g2.fillOval((int)(mx - w / SIZE / 2 + BORDER), (int)(my - h / SIZE / 2 + BORDER), (int)(w / SIZE - 2 * BORDER),
                    (int)(h / SIZE - 2 * BORDER));
      }
