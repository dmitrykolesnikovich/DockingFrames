...
public class ImagePanel extends JLabel {
  ...
  public ImagePanel(BufferedImage image) {
    if (image != null) {
      ...
      thumbnail = image.getScaledInstance((int)(image.getWidth() * factor), (int)(image.getHeight() * factor), Image.SCALE_SMOOTH);
  ...
  private class Listener extends MouseAdapter {
    ...
    public void mousePressed(MouseEvent e) {
      if (popup == null) {
        Point location = new Point((getWidth() - image.getWidth()) / 2, (getHeight() - image.getHeight()) / 2);
