...
public class ModifySingleDockable extends DefaultSingleCDockable {
  ...
  private static final PreferenceOperation REMOVE_SINGLE_BACKUP_FACTORY =
    new PreferenceOperation("remove backup factory", Icons.get("remove factory"), "CControl.removeSingleBackupFactory");
  ...
  private class Entry extends AbstractPreference<String> {
    ...
    public PreferenceOperation[] getOperations() {
      return new PreferenceOperation[]{PreferenceOperation.DELETE, REMOVE_SINGLE_BACKUP_FACTORY, ADD_SINGLE_BACKUP_FACTORY,
        REMOVE_SINGLE_DOCKABLE, ADD_SINGLE_DOCKABLE};
    }
  ...
  private class NewEntry extends AbstractPreference<String> {
    ...
    @Override
    public PreferenceOperation[] getOperations() {
      return new PreferenceOperation[]{ADD_SINGLE_BACKUP_FACTORY, ADD_SINGLE_DOCKABLE};
    }
    ...
    public boolean isEnabled(PreferenceOperation operation) {
      ...
      for (int i = 0, n = model.getSize(); i < n; i++) {
        ...
        if (preference instanceof Entry) {
          if (((Entry)preference).id.equals(value)) return false;
        }
      }
      return true;
    }
